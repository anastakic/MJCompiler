...
"^" 		{ return new_symbol(sym.SQRT, yytext()); }
"@" 		{ return new_symbol(sym.MODIF_JAN, yytext()); }
...
"++" 		{ return new_symbol(sym.PLUS2, yytext()); }
"--" 		{ return new_symbol(sym.MINUS2, yytext()); }
...
"null"			{ return new_symbol(sym.NULL, new String (yytext())); }
